...
> When performing probe results aggregation all values such as probed elements, runTime and forecastTime will be arrays ordered according to ascending time
